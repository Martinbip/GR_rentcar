    ...
    switch (step) {
      case STEPS.LOCATION:
        return (
          <div className="flex flex-col gap-8">
            <Heading
              title="Where do you want to rent a car?"
              subtitle="Book a car in just a few simple steps."
            />
            <CountrySelect
              value={location}
      ...
      case STEPS.DATE:
        return (
          <div className="flex flex-col gap-8">
            <Heading
              title="When would you like to rent the car?"
              subtitle="We'll find the perfect vehicle for you."
            />
            <Calendar
